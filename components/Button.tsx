...
export const Button: React.FC<ButtonProps> = ({
  ...
  const sizeStyles = {
    sm: "px-3 py-1.5 text-[11px] sm:px-4 sm:py-2 sm:text-xs gap-1.5",
    md: "px-4 py-2.5 text-xs sm:px-6 sm:py-3 sm:text-sm gap-2",
    lg: "px-5 py-3 text-xs sm:px-8 sm:py-4 sm:text-base gap-2 shadow-md sm:shadow-lg"
  };
